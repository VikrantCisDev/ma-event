...
const ImageCard = ({ data, cardStyle }) => {
  ...
  return (
    <Card className={`border-0 ${cardStyle ? cardStyle : "default"}-cardStyle`}>
      {cardStyle === "secondary" ? (
      ...
      <Card.Body className={`${styleOptions[cardStyle] ? styleOptions[cardStyle] : styleOptions["default"]} pb-0`}>
